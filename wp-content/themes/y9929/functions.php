...
function y9929_settings(){
	...
	//Sizes custom
    //===================
    add_image_size('hero_v1', 1680,835, true); //Crop with true 
    add_image_size('single_v1', 1080,657, true); //Crop with true 
    add_image_size('single_v2', 832,576, true); //Crop with true
    add_image_size('gallery_v1', 356,439, true); //Crop with true 
    add_image_size('gallery_v2', 284,424, true); //Crop with true 
}
...
function y9929_styles(){
    ...
    //Main theme CSS
    wp_enqueue_style("theme", get_template_directory_uri().'/css/theme.css',array(),'1.0.7');
